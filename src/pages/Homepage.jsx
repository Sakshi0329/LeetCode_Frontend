    ...
    <div className="min-h-screen bg-base-200 transition-colors duration-300">
      ...
      <nav className="navbar bg-base-100 shadow-lg px-4 md:px-8">
        <div className="flex-1">
          <NavLink to="/" className="btn btn-ghost text-xl font-bold">LeetCode</NavLink>
        </div>
      ...
      <div className="container mx-auto p-4 md:p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredProblems.map(problem => (
            <div key={problem._id} className="card bg-base-100 shadow-md border border-base-300 hover:shadow-lg transition-shadow rounded-lg">
              <div className="card-body">
                <div className="flex items-center justify-between">
                  ...
                  {solvedProblems.some(sp => sp._id === problem._id) && (
                    <div className="badge badge-success gap-2 flex items-center">
